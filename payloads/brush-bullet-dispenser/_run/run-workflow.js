export const meta = {
  name: 'brush-bullet-dispenser',
  description: 'Design the Quiver brush-bullet dispenser payload: research-first mechanism survey, judged trade study, CAD critic loop, electronics, drop-ballistics sim gate, red team',
  phases: [
...
const DOMAINS = [
  ...
  ['drone-spreaders', 'existing drone spreading/dispensing systems (DJI Agras T-series spreader, granular applicators, prior drone brush-bullet or tebuthiuron pellet dispenser attempts) AND commercial brush bullet / tebuthiuron pellet product data: pellet hardness, moisture behavior, dust, exact dimensions'],
]
