export const meta = {
  ...
  description: 'Rev-1 CAD completion for the brush-bullet agricultural granule dispenser: punch-list synthesis, build/critic loop until the CAD closes, verify pass, packager',
  phases: [
