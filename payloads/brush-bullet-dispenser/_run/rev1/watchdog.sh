#!/bin/zsh
# Watchdog for the brush-bullet dispenser rev-1 workflow host.
...
SCRIPT="/Users/hex/projects/payload-systems/payloads/brush-bullet-dispenser/_run/rev1/run-workflow.js"
