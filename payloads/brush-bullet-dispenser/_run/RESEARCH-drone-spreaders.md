# RESEARCH — Drone spreading/dispensing systems + brush-bullet pellet product data
...
brush-bullet / tebuthiuron-class pellet product data (hardness, moisture, dust,
...
**[V]** EPA label, *BRUSH BULLET HERBICIDE*, EPA Reg. No. 102162-1, stamped
2023-04-05, manufactured by/for **Brush Bullet Manufacturing, LLC** —
...
| Application method | `Apply BRUSH BULLET HERBICIDE by hand or with an exact delivery handgun applicator or other exact delivery device to the soil around specific plants or in a grid pattern for area control.` |
...
Thomas's pellet *is* the registered Brush Bullet pellet, and the manufacturer's
...
"more brush bullets isn't a bad thing".
...
- **[D]** 623.7 g ÷ 975 = **0.64 g/pellet** (≈709 pellets/lb).
  **Brush Bullet's pellet is ~1.9× the mass of a Pronone pellet** — same
...
No hardness or friability figure is published for Brush Bullet itself
...
> **Whole-pellet crush load for a 12 mm Brush-Bullet-class pellet ≈ 41 N ≈ 4.2 kgf [D]**
...
- **[V]** Brush Bullet Manufacturing sells an **Applicator Pod**, **$650**,
  **battery powered**, mounted by **1" ball mount or 1/4-20 thread**, described
  as a "Multi-Equipment Brush Bullet applicator" —
  https://brush-bullet.myshopify.com/products/applicator-pod
...
- **[V2]** Vendor claims aerial use "by helicopter or other aerial platforms"
  via the Brush Pod — https://brush-bullet.myshopify.com/
- **[V]** Internal prior art: Arrow DAO thread "Brush Bullet Applicator (aka.
  ...
  https://dao.arrowair.com/t/brush-bullet-applicator-aka-brush-pod-reverse-modeling/88
...
- **[V2] Historical baseline** for the grid application our pellet descends from:
  ...
  is the product.**
- **Prior *counted* brush-bullet drone attempts: none found in the public
...
> brush bullets and it could prevent the wheel from turning"*
...
This is exactly Thomas's "1.5 brush bullets" case: a proud fragment carried out
...
**Pellet / product**
- EPA label, Brush Bullet Herbicide, Reg. 102162-1 (downloaded + text-extracted this pass) — https://www3.epa.gov/pesticides/chem_search/ppls/102162-00001-20230405.pdf
- Brush Bullet vendor site / Applicator Pod — https://brush-bullet.myshopify.com/ , https://brush-bullet.myshopify.com/products/applicator-pod
- Brush Pod in use (video) — https://www.youtube.com/watch?v=8JXTMeRnTko
- Arrow DAO Brush Pod reverse model — https://dao.arrowair.com/t/brush-bullet-applicator-aka-brush-pod-reverse-modeling/88
