...
tablet handling), evaluated against the capsule dispenser problem.
...
1. **Pellet friability, crush strength, moisture swelling.** No manufacturer data
   ...
   is a scanned image — no extractable text on pellet physicals. capsule's
   site exposes no specs
   ([capsule.myshopify.com](https://capsule.myshopify.com/)).
