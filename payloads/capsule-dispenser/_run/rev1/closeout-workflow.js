...
const CTX = `You are part of the capsule dispenser close-out run (agricultural granule-metering payload for a UAS; pure CAD work). Repo: /Users/hex/projects/payload-systems, branch capsule-dispenser (already checked out — do NOT switch branches, do NOT push). Package root: ${ROOT}. Read ${R1}/CONTEXT.md for standing directives and ${R1}/VERIFY.md for the independent verification this run must close. The r12 exports in ${ROOT}/cad/exports/ are the shipped baseline; your work produces export tag r13. Every claim of "fixed" or "measured" must quote the printed output of an actual geometry check (OCP/trimesh), never a narrated summary. `
