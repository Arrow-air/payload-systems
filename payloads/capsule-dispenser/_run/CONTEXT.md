# capsule Dispenser — Ground Truth Pack (source of truth for ALL agents)
...
- ASSUMPTION (research task): hardness numbers, moisture swelling — research
  from commercial product data (tebuthiuron pellets, "capsules",
  Spike 20P class).

## Requirements (Thomas, 2026-08-06, verbatim)

- Capacity: > "250 pellets would be an ideal minimum." and (2026-08-06,
  later): > "More capsules isnt a bad thing, it can be more than 250
...
## Output layout (all inside payloads/capsule-dispenser/)
...
> to the pocket wheel slot, you'd have 1.5 capsules and it could prevent
