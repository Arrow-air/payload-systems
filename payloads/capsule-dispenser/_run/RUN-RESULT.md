# RUN RESULT — capsule Dispenser, rev-0 design package
...
`capsule-dispenser` as `c123265`, author `thomasg <thomas@arrowair.com>`,
message `capsule-dispenser: rev-0 design package (overnight run)`.
**Not pushed.** 172 files, the whole `payloads/capsule-dispenser/` folder.
...
branch  capsule-dispenser  (NOT pushed)
author  thomasg <thomas@arrowair.com>
subject capsule-dispenser: rev-0 design package (overnight run)
files   172  (payloads/capsule-dispenser/ only)
```
